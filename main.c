...
u8   UART_Rx_Buff[4]={0};
volatile u8 UART_Tx_Buff; 
extern BitStatus receive_flag;
uint16_t ADC_Mesh_Val,RD_Mesh_Opcode;
RD_Mesh_2_stm8_typedef *pointer,RD_Mesh_receive_data;
